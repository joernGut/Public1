...
$StartPath = "C:\work\Fileserver" 

# Output Excel file path
$ExcelOutput = "C:\temp\FileScanReport.xlsx" 

# Base SharePoint URL for the document library (adjust as needed)
$SharePointBaseUrl = "https://yourtenant.sharepoint.com/sites/projects/Documents"
